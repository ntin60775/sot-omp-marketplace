...
2026-09-21): version `0.3.16` (версия каталога), две записи — `ontoship` v0.4.8
(git-subdir, `path: ".omp"`, `ref: "v0.4.8"`) и `1c` v0.1.6 (url, `ref: "v0.1.6"`). Кого эти записи обслуживают и что у них стоит фактически — реестр
